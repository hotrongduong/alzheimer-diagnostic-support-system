...
// <--- THÊM BIẾN NÀY ĐỂ TRỎ VỀ THƯ MỤC GỐC "ohif/"
...
module.exports = (env, argv, { SRC_DIR, ENTRY }) => {
  ...
  const config = {
    ...
    resolve: {
      ...
      alias: {
        // <--- THÊM ALIAS VÀO ĐÂY
        '@ohif/extension-alzheimer-ai-diagnosis': path.resolve(
          ROOT_DIR,
          'extensions/alzheimer-ai-diagnosis/src/index.ts'
        ),
        // Giữ nguyên các alias khác
